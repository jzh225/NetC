...
namespace Weeho.Infrastructure.HttpUtility
{
    ...
    public static class RequestUtility
    {
        ...
        /// <returns>System.String.</returns>
        public static string HttpGet(string url, CookieContainer cookieContainer = null, SortedDictionary<string, string> headerValues = null,
            Encoding encoding = null, X509Certificate cer = null, int timeOut = 10000)
        {
            ...
            {
                foreach (KeyValuePair<string, string> temp in headerValues)
                {
        ...
        /// <param name="encoding">The encoding.</param>
        /// <param name="cer">The cer.</param>
        /// <param name="timeOut">The time out.</param>
        /// <returns>System.String.</returns>
        public static string HttpPost(string url, CookieContainer cookieContainer = null, Dictionary<string, string> formData = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = 10000)
        {
        ...
        /// <returns>System.String.</returns>
        public static string HttpPost(string url, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = 10000, bool checkValidationResult = false)
        {
            try
            {
        ...
        /// <param name="timeOut">The time out.</param>
        /// <returns>Task&lt;System.String&gt;.</returns>
        public static async Task<string> HttpGetAsync(string url, CookieContainer cookieContainer = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = 10000)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "GET";
            request.Timeout = timeOut;
        ...
        /// <param name="timeOut">The time out.</param>
        /// <returns>Task&lt;System.String&gt;.</returns>
        public static async Task<string> HttpPostAsync(string url, CookieContainer cookieContainer = null, Dictionary<string, string> formData = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = 10000)
        {
            MemoryStream ms = new MemoryStream();
        ...
        /// <param name="checkValidationResult">验证服务器证书回调自动验证</param>
        /// <returns>Task&lt;System.String&gt;.</returns>
        public static async Task<string> HttpPostAsync(string url, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, X509Certificate cer = null, int timeOut = 10000, bool checkValidationResult = false)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.Timeout = timeOut;
        ...
        /// <returns><c>true</c> if [is weixin client request] [the specified HTTP context]; otherwise, <c>false</c>.</returns>
